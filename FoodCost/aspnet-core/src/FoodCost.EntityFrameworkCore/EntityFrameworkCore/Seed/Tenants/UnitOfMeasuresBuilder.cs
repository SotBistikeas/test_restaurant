    ...
    public class UnitOfMeasuresBuilder
    {
        ...
        private void CreateUnitOfMeasures()
        {
            ...
            if (!_context.UnitOfMeasures.Any())
            {
                ...
                _context.UnitOfMeasures.Add(new UnitOfMeasure { Id = 310, MeasureGroup = metric, UnitOfMeasureType = UnitOfMeasureType.Volume, System = "Imperial / USCS", Name = "Teaspoon UK", Symbol = "tsp", BaseEquivalent = 0.00591939m });
                ...
                _context.UnitOfMeasures.Add(new UnitOfMeasure { Id = 314, MeasureGroup = metric, UnitOfMeasureType = UnitOfMeasureType.Volume, System = "Imperial / USCS", Name = "Tablespoon Australia", Symbol = "tbsp", BaseEquivalent = 0.02m });
                ...
                _context.UnitOfMeasures.Add(new UnitOfMeasure { Id = 320, MeasureGroup = metric, UnitOfMeasureType = UnitOfMeasureType.Volume, System = "Imperial / USCS Australia/Canada", Name = "Cup", Symbol = "cup", BaseEquivalent = 0.25m });
