  ...
  <div class="all">
    ...
    <transition name="fade">
      <div v-if="isOpen" class="info">
        ...
        <p>
          Once you are in your account you need to enter all products going in the kitchen along with their cost. After that, use these
          products to create your dishes. You have now a first look at how much each dish cost based on their ingredients
        </p>
        <p>
          Now you need to enter the monthly expencies of the restaurant (util bills, wages, rent etc). Finnaly enter an avarege number of
          dishes the restaurant serves in daily base.
        </p>
        <h3>
