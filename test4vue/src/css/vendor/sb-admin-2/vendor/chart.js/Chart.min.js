...
!(function(t, e) {
  ...
  var Mt = wt;
  st._set('global', {
    elements: { arc: { backgroundColor: st.global.defaultColor, borderColor: '#fff', borderWidth: 2, borderAlign: 'center' } }
  });
  var _t = pt.extend({
    ...
    var n,
      ...
      l = (function(t) {
        var e = t.borderSkipped,
          i = {};
        return e
          ? (t.horizontal ? t.base > t.x && (e = Ot(e, 'left', 'right')) : t.base < t.y && (e = Ot(e, 'bottom', 'top')), (i[e] = !0), i)
          : i;
      })(t);
    return (
      ...
      drawTitle: function(t, e, i) {
        ...
        if (n.length) {
          ...
          var a,
            ...
            s = e.titleSpacing;
          for (
            i.fillStyle = e.titleFontColor, i.font = ut.fontString(r, e._titleFontStyle, e._titleFontFamily), a = 0, o = n.length;
            a < o;
            ++a
          )
  ...
  si._date.override(
    'function' == typeof t
      ? {
          ...
          parse: function(e, i) {
            return (
              'string' == typeof e && 'string' == typeof i ? (e = t(e, i)) : e instanceof t || (e = t(e)), e.isValid() ? e.valueOf() : null
            );
          },
          format: function(e, i) {
            return t(e).format(i);
