...
!(function(t, e) {
  ...
  (j.prototype = {
    ...
    mix: function(t, e) {
      var i = t,
        ...
        s = 1 - o;
      return this.rgb(o * this.red() + s * i.red(), o * this.green() + s * i.green(), o * this.blue() + s * i.blue()).alpha(
  ...
  var lt = {
      ...
      toPadding: function(t) {
        var e, i, n, a;
        return (
          Z.isObject(t) ? ((e = +t.top || 0), (i = +t.right || 0), (n = +t.bottom || 0), (a = +t.left || 0)) : (e = i = n = a = +t || 0),
      ...
      resolve: function(t, e, i) {
        ...
        for (n = 0, a = t.length; n < a; ++n)
          if (
            void 0 !== (r = t[n]) &&
            (void 0 !== e && 'function' == typeof r && (r = r(e)), void 0 !== i && Z.isArray(r) && (r = r[i]), void 0 !== r)
          )
            return r;
      }
    },
  ...
  Object.defineProperty(mt.prototype, 'animationObject', {
    ...
    ot._set('global', { animation: { duration: 1e3, easing: 'easeOutQuart', onProgress: ut.noop, onComplete: ut.noop } });
  var vt = {
      animations: [],
      request: null,
  ...
  var kt = _t;
  ot._set('global', {
    elements: { arc: { backgroundColor: ot.global.defaultColor, borderColor: '#fff', borderWidth: 2, borderAlign: 'center' } }
  });
  var wt = gt.extend({
        ...
        for (
          ...
          (e = s[t]),
            ...
            0 === t
              ...
              : ((i = -1 === d ? i : s[d]),
                n.skip || ((d !== t - 1 && !o) || -1 === d ? r.moveTo(n.x, n.y) : ut.canvas.lineTo(r, i._view, e._view), (d = t)));
        r.stroke(), r.restore();
      }
    }),
    ...
    var n,
      ...
      l = (function(t) {
        var e = t.borderSkipped,
          i = {};
        return e
          ? (t.horizontal ? t.base > t.x && (e = Rt(e, 'left', 'right')) : t.base < t.y && (e = Rt(e, 'bottom', 'top')), (i[e] = !0), i)
          : i;
      })(t);
    return (
      ut.isObject(s) ? ((n = +s.top || 0), (a = +s.right || 0), (r = +s.bottom || 0), (o = +s.left || 0)) : (n = a = r = o = +s || 0),
      {
            ...
            'flex' === n.barThickness
              ...
              : (function(t, e, i) {
                  var n,
                    ...
                    s = e.pixels[t];
                  return (
                    ut.isNullOrUndef(r) ? ((n = e.min * i.categoryPercentage), (a = i.barPercentage)) : ((n = r * o), (a = 1)),
  ...
  var Xt = kt.extend({
    ...
    updateElement: function(t, e, i) {
      ...
      var v = t._model;
      (i && s.animateRotate) ||
        ((v.startAngle = 0 === e ? o.rotation : n.getMeta().data[e - 1]._model.endAngle), (v.endAngle = v.startAngle + v.circumference)),
        t.pivot();
    },
      ...
      return (
        ...
        i && i.canvas === t
          ? ((function(t, e) {
              ...
              if (
                ((t[Me] = { initial: { height: n, width: a, style: { display: i.display, height: i.height, width: i.width } } }),
      ...
      drawTitle: function(t, e, i) {
        ...
        if (n.length) {
          ...
          var a,
            ...
            s = e.titleSpacing;
          for (
            i.fillStyle = e.titleFontColor, i.font = ut.fontString(o, e._titleFontStyle, e._titleFontFamily), a = 0, r = n.length;
            a < r;
            ++a
          )
  ...
  ut.extend(ni.prototype, {
      ...
      return (
        ut.each(
          ...
          function(i, n) {
            ...
            if ((a.type && a.type !== r && (t.destroyDatasetMeta(n), (a = t.getDatasetMeta(n))), (a.type = r), a.controller))
    ...
    getDatasetMeta: function(t) {
      ...
      return (
        i || (i = e._meta[this.id] = { type: null, data: [], dataset: null, controller: null, hidden: null, xAxisID: null, yAxisID: null }),
        i
      );
    },
  ...
  var fi = gt.extend({
      ...
      calculateTickRotation: function() {
        ...
        if (n.length && t.options.display && t.isHorizontal())
          for (
            var o, s = ut.longestText(e, a.string, n, t.longestTextCache), l = s, u = t.getPixelForTick(1) - t.getPixelForTick(0) - 6;
            l > u && r < i.maxRotation;
      ...
      fit: function() {
        ...
        if (
          ((e.width = u ? (t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth) : s && o.drawTicks ? c : 0),
            ...
            (ut.each(y, function(n, s) {
              if (!ut.isNullOrUndef(n.label)) {
                ...
                s === e.zeroLineIndex && i.offset === h.offsetGridLines
                  ? ((l = h.zeroLineWidth), (u = h.zeroLineColor), (d = h.zeroLineBorderDash || []), (c = h.zeroLineBorderDashOffset || 0))
                  : ((l = di(h.lineWidth, s)), (u = di(h.color, s)), (d = h.borderDash || []), (c = h.borderDashOffset || 0));
        ...
        var t = this,
          ...
          a = (t.ticks = (function(t, e) {
            ...
            (r = Math.ceil(g / m) - Math.floor(f / m)) > u && (m = ut.niceNum((r * m) / u / l) * l),
              s || vi(c) ? (i = Math.pow(10, ut._decimalPlaces(m))) : ((i = Math.pow(10, c)), (m = Math.ceil(m * i) / i)),
              (n = Math.floor(f / m) * m),
              (a = Math.ceil(g / m) * m),
              s && (!vi(d) && ut.almostWhole(d / m, m / 1e3) && (n = d), !vi(h) && ut.almostWhole(h / m, m / 1e3) && (a = h)),
              (r = (a - n) / m),
          ...
          ut.each(n, function(n, a) {
            ...
            i.isDatasetVisible(a) &&
              ...
              ut.each(n.data, function(i, n) {
                ...
                isNaN(a) ||
                  o.data[n].hidden ||
                  ((u[n] = u[n] || 0), (d[n] = d[n] || 0), e.relativePoints ? (u[n] = 100) : a < 0 ? (d[n] += a) : (u[n] += a));
              });
          }),
  ...
  var Si = fi.extend({
      ...
      getPixelForValue: function(t) {
        ...
        return (
          ...
          o.isHorizontal() ? ((e = o.width), (i = l ? o.right : o.left)) : ((e = o.height), (r *= -1), (i = l ? o.top : o.bottom)),
          t !== n &&
      ...
      getValueForPixel: function(t) {
        ...
        if (
          ...
          r.isHorizontal() ? ((e = r.width), (a = s ? r.right - t : t - r.left)) : ((e = r.height), (a = s ? t - r.top : r.bottom - t)),
          a !== i)
        ) {
          if (0 === i) {
          ...
          ? (function(t) {
              ...
              for (e = 0; e < d; e++) {
                (n = t.getPointPosition(e, t.drawingArea + 5)),
                  ...
                  (l = a.lineHeight),
                  (u = t.pointLabels[e] || ''),
                  (i = ut.isArray(u) ? { w: ut.longestText(s, s.font, u), h: u.length * l } : { w: s.measureText(u).width, h: l }),
  ...
  var Ji = fi.extend({
        ...
        return (
          ...
          (n._offsets = (function(t, e, i, n, a) {
            ...
            return (
              a.offset &&
                e.length &&
                (a.time.min || ((r = qi(t, 'time', e[0], 'pos')), (s = 1 === e.length ? 1 - r : (qi(t, 'time', e[1], 'pos') - r) / 2)),
                a.time.max ||
          ...
          (function(t, e, i) {
            var n,
              ...
              o,
              s = [];
            for (n = 0, a = e.length; n < a; ++n) (r = e[n]), (o = !!i && r === +t._adapter.startOf(r, i)), s.push({ value: r, major: o });
            return s;
          })(n, u, n._majorUnit)
        );
      },
      ...
      getPixelForValue: function(t, e, i) {
        var n = null;
        if ((void 0 !== e && void 0 !== i && (n = this._timestamps.datasets[i][e]), null === n && (n = $i(this, t)), null !== n))
      ...
      t.exports = (function() {
        ...
        function Bt(t, e, i, n, a) {
          var r,
            ...
            u = 1 + 7 * (e - 1) + s + l;
          return (
            u <= 0 ? (o = St((r = t - 1)) + u) : u > St(t) ? ((r = t + 1), (o = u - St(t))) : ((r = t), (o = u)), { year: r, dayOfYear: o }
          );
        }
        function jt(t, e, i) {
          var n,
              ...
              for (a = U(t._f, t._locale).match(z) || [], e = 0; e < a.length; e++)
                (r = a[e]),
                  (i = (s.match(dt(r, t)) || [])[0]) &&
                    ...
                    (u += i.length)),
                  E[r] ? (i ? (f(t).empty = !1) : f(t).unusedTokens.push(r), mt(r, i, t)) : t._strict && !i && f(t).unusedTokens.push(r);
                          ...
                          o(e)
                            ...
                            ? (function(t) {
                                ...
                                null === e
                                  ? (we(t),
                                    !1 === t._isValid &&
                                      (delete t._isValid, Ce(t), !1 === t._isValid && (delete t._isValid, n.createFromInputFallback(t))))
                                  : (t._d = new Date(+e[1]));
                              })(t)
                            : a(e)
        ...
        function qe(t, e) {
          ...
          return (
            Ye(t)
              ...
              : (h = Ue.exec(t))
              ? ((i = '-' === h[1] ? -1 : 1),
                (u = { y: 0, d: k(h[yt]) * i, h: k(h[bt]) * i, m: k(h[xt]) * i, s: k(h[_t]) * i, ms: k(Ne(1e3 * h[kt])) * i }))
              : (h = Ge.exec(t))
              ? ((i = '-' === h[1] ? -1 : 1),
                (u = { y: Ze(h[2], i), M: Ze(h[3], i), w: Ze(h[4], i), d: Ze(h[5], i), h: Ze(h[6], i), m: Ze(h[7], i), s: Ze(h[8], i) }))
              : null == u
              ? (u = {})
              : 'object' == typeof u &&
                ('from' in u || 'to' in u) &&
                ...
                (a =
                  r.isValid() && o.isValid()
                    ? ((o = Ee(o, r)),
                      r.isBefore(o) ? (l = $e(r, o)) : (((l = $e(o, r)).milliseconds = -l.milliseconds), (l.months = -l.months)),
                      l)
        ...
        (bi.add = Je),
          ...
          (bi.zone = S('moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/', function(
            t,
            e
          ) {
        ...
        (_i.calendar = function(t, e, i) {
          ...
          (_i.monthsParse = function(t, e, i) {
            ...
            for (
              this._monthsParse || ((this._monthsParse = []), (this._longMonthsParse = []), (this._shortMonthsParse = [])), n = 0;
              n < 12;
              n++
            ) {
              if (
        ...
        return (
          ...
          (Qi._bubble = function() {
            var t,
              ...
              l = this._data;
            return (
              (r >= 0 && o >= 0 && s >= 0) || (r <= 0 && o <= 0 && s <= 0) || ((r += 864e5 * Ci(Ti(s) + o)), (o = 0), (s = 0)),
              ...
              for (t.beginPath(), o = 0, s = f + !!r; o < s; ++o)
                (d = i((u = e[(l = o % f)]._view), l, n)),
                  ...
                  h && c
                    ...
                    : v && y && (g ? (h && m.push(u), c && p.push(d)) : (hn(t, m, p, v, y), (v = y = 0), (m = []), (p = [])));
        ...
        if (((a.font = r.string), u)) {
          ...
          (a.textAlign = 'left'),
            ...
            ut.each(t.legendItems, function(t, e) {
              ...
              (0 === e || d[d.length - 1] + n + i.padding > l.width) && ((h += o + i.padding), (d[d.length - (e > 0 ? 0 : 1)] = i.padding)),
