...
!(function() {
  ...
  (pt.prototype = {
    ...
    then: function(t, e) {
      ...
      return (
        (!e && !t) || this._handled || ((this._handled = !0), this._state === $ && et && it(ht, this)),
  ...
  function Et(t) {
    ...
    u && (v.attributes[U] = ''),
      s && v.children.push({ tag: 'title', attributes: { id: v.attributes['aria-labelledby'] || 'title-'.concat(xt()) }, children: [s] });
    var b,
      y,
      w,
      x,
          ...
          ? ((y = (b = D).children),
            ...
            (_ = {
              ...
              children: [
                ...
                {
                  tag: 'mask',
                  attributes: B({}, Ot, { id: P, maskUnits: 'userSpaceOnUse', maskContentUnits: 'userSpaceOnUse' }),
                  children: [O, j]
                }
              ]
            }),
            y.push(_, {
              tag: 'rect',
              attributes: B({ fill: 'currentColor', 'clip-path': 'url(#'.concat(L, ')'), mask: 'url(#'.concat(P, ')') }, Ot)
            }),
                  ...
                  children: [
                    {
                      ...
                      children: [{ tag: a.icon.tag, children: a.icon.children, attributes: B({}, a.icon.attributes, o.path) }]
                    }
                  ]
                });
              } else e.push(a.icon);
  ...
  function jt(t) {
    ...
    zt(r) &&
      ...
      (b +=
        (v = void 0 !== g && g) && k
          ? 'translate('.concat(u.x / vt - m / 2, 'em, ').concat(u.y / vt - p / 2, 'em) ')
          : v
          ? 'translate(calc(-50% + '.concat(u.x / vt, 'em), calc(-50% + ').concat(u.y / vt, 'em)) ')
  ...
  var Pt = function() {},
    ...
    Tt = function(t) {
      Lt.mark(''.concat(_t, ' ').concat(t, ' ends')),
        Lt.measure(''.concat(_t, ' ').concat(t), ''.concat(_t, ' ').concat(t, ' begins'), ''.concat(_t, ' ').concat(t, ' ends'));
    },
    Rt = {
      begin: function(t) {
        return (
        ...
        ne ||
          kt(t).forEach(function(t) {
            if (
              ...
              'attributes' === t.type && Zt(t.target) && ~H.indexOf(t.attributeName))
            )
  ...
  function oe(t) {
    ...
    return (
      ...
      o.prefix && 1 < i.length
        ...
        : o.prefix && 1 === i.length && (o.iconName = Bt(o.prefix, It(t.innerText))),
      o
    );
  }
  var ce = function(t) {
  ...
  function se(t) {
    var e,
      ...
      V.autoA11y &&
        (o
          ? (i['aria-labelledby'] = ''.concat(V.replacementClass, '-title-').concat(xt()))
    ...
    he = {
      ...
      children: [
        de,
        {
          ...
          children: [
            { tag: 'animate', attributes: B({}, ue, { attributeName: 'r', values: '28;14;28;28;14;28;' }) },
            { tag: 'animate', attributes: B({}, me, { values: '1;0;1;1;0;1;' }) }
          ]
        },
        {
          tag: 'path',
  ...
  function ge(r, i) {
    return new gt(function(t, e) {
      ...
      if (r && i && pe[i] && pe[i][r]) {
        var a = pe[i][r];
        return t(
          (n = { found: !0, width: a[0], height: a[1], icon: { tag: 'path', attributes: { fill: 'currentColor', d: a.slice(4)[0] } } })
        );
      }
    ...
    return ~a.extra.classes.indexOf(P)
      ? (function(t, e) {
          ...
          return (
            ...
            gt.resolve([t, jt({ content: t.innerHTML, width: i, height: o, transform: a, title: n, extra: r, watchable: !0 })])
          );
        })(t, a)
      : ((i = t),
        (o = (e = a).iconName),
              ...
              Object.keys(r).forEach(function(t) {
                (e.definitions[t] = B({}, e.definitions[t] || {}, r[t])),
                  (function t(e, a) {
                    ...
                    'function' != typeof q.hooks.addPack || r ? (q.styles[e] = B({}, q.styles[e] || {}, i)) : q.hooks.addPack(e, i),
                      'fas' === e && t('fa', a);
                  })(t, r[t]),
                  Xt();
              });
    ...
    _e = {
      ...
      watch: function() {
        ...
        !1 === V.autoReplaceSvg && (V.autoReplaceSvg = !0),
          ...
          K(function() {
            He({ autoReplaceSvgRoot: e }), ie({ treeCallback: ye, nodeCallback: we, pseudoElementsCallback: Ce, observeMutationsRoot: n });
          });
      }
    },
    Te = ((je = function(t) {
      ...
      if (t) {
        ...
        return Oe(B({ type: 'icon' }, t), function() {
          return (
            ...
            V.autoA11y &&
              (l
                ? (m['aria-labelledby'] = ''.concat(V.replacementClass, '-title-').concat(xt()))
        ...
        return Oe({ type: 'counter', content: t }, function() {
          return (
            ...
            (function(t) {
              ...
              content: t.toString(),
              title: a,
              extra: { attributes: c, styles: l, classes: [''.concat(V.familyPrefix, '-layers-counter')].concat(m(i)) }
            })
          );
        });
      },
  ...
  !(function(t) {
    ...
    u &&
      ...
      K(function() {
        He(), ie({ treeCallback: ye, nodeCallback: we, pseudoElementsCallback: Ce });
      })),
      (q.hooks = B({}, q.hooks, {
