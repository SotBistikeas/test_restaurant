...
!(function(t, e) {
      ...
      return (
        ...
        (a._jQueryInterface = function(i) {
          return this.each(function() {
            ...
            if (
              (!e && n.toggle && /show|hide/.test(i) && (n.toggle = !1), e || ((e = new a(this, n)), t.data(ct, e)), 'string' == typeof i)
            ) {
  ...
  for (
    var Tt = 'undefined' != typeof window && 'undefined' != typeof document, St = ['Edge', 'Trident', 'Firefox'], Dt = 0, It = 0;
    It < St.length;
    It += 1
  )
      ...
      modifiers: {
              ...
              u = {
                ...
                secondary: function(t) {
                  var e = 'right' === t ? 'left' : 'top',
                    n = h[e];
                  return (
                    h[t] > l[t] && !i.escapeWithReference && (n = Math.min(h[e], l[t] - ('right' === t ? h.width : h.height))), Kt({}, e, n)
                  );
                }
              };
            return (
        ...
        inner: {
          ...
          fn: function(t) {
            ...
            return (
              (o[s ? 'left' : 'top'] = r[n] - (a ? o[s ? 'width' : 'height'] : 0)), (t.placement = te(e)), (t.offsets.popper = Vt(o)), t
            );
          }
        },
        hide: {
